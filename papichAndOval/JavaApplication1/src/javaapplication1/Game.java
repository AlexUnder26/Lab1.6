...
public class Game extends JFrame{
    ...
    private static Image nav;
    private static Image tromb;
    ...
    public static void main(String[] args) throws IOException {
        ...
        nav = ImageIO.read(Game.class.getResourceAsStream("/nav.png"));
        tromb = ImageIO.read(Game.class.getResourceAsStream("/tromb.png"));
    ...
    public static void onRepaint(Graphics g){
        ...
        g.drawImage(tromb, (int) drop_left, (int) drop_top, null);
