...
papich = ImageIO.read(Game.class.getResourceAsStream("/end.png"));
nuts = ImageIO.read(Game.class.getResourceAsStream("/tromb.png"));
end = ImageIO.read(Game.class.getResourceAsStream("/nav.png"));
game_game = new Game();
...
if(drop_top > game_game.getHeight()) g.drawImage(end, 0, 0, null);
}
